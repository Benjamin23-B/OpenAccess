  ...
  return (
    <div className="bg-white dark:bg-[#1E293B] border border-[#D8E2EC] dark:border-[#334155] rounded-2xl p-6 md:p-7 shadow-[0_4px_12px_rgba(15,23,42,0.06)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.35)] flex flex-col gap-6" role="region" aria-label="Speech controls">
      ...
      <section className="flex flex-col gap-4" aria-labelledby="stt-heading">
        <h3 id="stt-heading" className="text-[20px] font-semibold text-[#16324F] dark:text-white flex items-center gap-2.5">
        ...
        <div className="flex gap-4 flex-wrap items-center">
          <button
            ...
            className={`h-[48px] px-6 font-semibold rounded-xl text-[15px] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md cursor-pointer flex items-center justify-center gap-2 text-white shadow-sm ${
              isListening ? 'bg-[#C0392B] dark:bg-[#DC2626] animate-pulse' : 'bg-[#198754] dark:bg-[#16A34A] hover:bg-[#146c43]'
      ...
      <section className="flex flex-col gap-4" aria-labelledby="tts-heading">
        <h3 id="tts-heading" className="text-[20px] font-semibold text-[#16324F] dark:text-white flex items-center gap-2.5">
          <svg className="w-5 h-5 text-[#0F4C81] dark:text-[#3B82F6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Voice Settings */}
      <section className="flex flex-col gap-4 border-t border-[#D8E2EC] dark:border-[#334155] pt-5" aria-labelledby="voice-heading">
        <h3 id="voice-heading" className="text-[20px] font-semibold text-[#16324F] dark:text-white flex items-center gap-2.5">
          <svg className="w-5 h-5 text-[#0F4C81] dark:text-[#3B82F6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="flex flex-col gap-2">
            <label className="text-[13px] font-bold text-[#475569] dark:text-[#CBD5E1]">Speech Language:</label>
            <select
              value={selectedLanguage}
              onChange={(e) => onLanguageChange(e.target.value as any)}
              className="bg-white dark:bg-[#0F172A] text-[#16324F] dark:text-[#F8FAFC] border border-[#CBD5E1] dark:border-[#475569] rounded-xl px-4 py-2.5 text-[14px] font-bold outline-none focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/30 cursor-pointer shadow-xs"
            >
              <option value="en-IN" className="bg-white dark:bg-[#0F172A] text-[#16324F] dark:text-[#F8FAFC]">English (India)</option>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center text-[13px]">
              <label className="font-semibold text-[#64748B] dark:text-[#CBD5E1]">Speech Speed Rate:</label>
              <span className="font-mono font-bold text-[#0F4C81] dark:text-[#3B82F6]">{rate}x</span>
            </div>
            <input
              type="range"
              min="0.5"
              ...
              className="w-full accent-[#0F4C81] dark:accent-[#3B82F6] cursor-pointer my-auto"
            />
          </div>

          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center text-[13px]">
              <label className="font-semibold text-[#64748B] dark:text-[#CBD5E1]">Audio Pitch Tone:</label>
              <span className="font-mono font-bold text-[#0F4C81] dark:text-[#3B82F6]">{pitch}</span>
            </div>
            <input
              type="range"
              min="0.5"
