...
export default function TranscriptionPanel({
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b-2 border-[#CBD5E1] dark:border-[#334155] pb-3 flex-wrap gap-2">
        <h2 id="transcription-heading" className="text-[20px] font-bold text-[#0F172A] dark:text-white flex items-center gap-2">
        ...
        <div className="flex items-center gap-3 text-[13.5px] text-[#334155] dark:text-[#CBD5E1] font-bold">
          {timestamp && (
            <span className="flex items-center gap-1 font-mono text-[#0F4C81] dark:text-[#3B82F6] font-bold" aria-label={`Last updated: ${timestamp}`}>
              <svg className="w-4 h-4 text-[#0F4C81] dark:text-[#3B82F6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative w-full">
        <textarea
          ...
          value={transcript}
          readOnly
          className="w-full bg-[#FFFFFF] dark:bg-[#0F172A] text-[#0F172A] dark:text-[#F8FAFC] border-2 border-[#CBD5E1] dark:border-[#475569] rounded-xl p-5 text-[15.5px] font-medium focus:outline-none focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/40 resize-none min-h-[140px] max-h-[260px] overflow-y-auto placeholder-[#475569] dark:placeholder-[#94A3B8] font-sans transition-all duration-200"
        ...
        {interimTranscript && (
          <div className="absolute bottom-3 left-4 right-4 bg-[#EFF6FF] dark:bg-[#1E3A8A] p-3 rounded-lg text-[14px] text-[#0F4C81] dark:text-[#93C5FD] font-bold animate-pulse border-2 border-[#BFDBFE] dark:border-[#3B82F6]">
